...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GithubReposJs = __webpack_require__(201);

	var _GithubReposJs2 = _interopRequireDefault(_GithubReposJs);

	var _GithubUserProfileJs = __webpack_require__(202);
	...
	var base = _reBase2['default'].createClass('https://react-gh-notes.firebaseio.com/');
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'col-md-4' },
	          _react2['default'].createElement(_NotesNotesJs2['default'], { username: username, notes: this.state.notes, addNote: this.handleAddNote.bind(this) })
	        )
	      );
	    }
	  }]);
